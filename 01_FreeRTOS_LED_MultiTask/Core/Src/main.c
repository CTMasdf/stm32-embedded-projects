...
int main(void)
{
  ...
  led1Handle = osThreadNew(Led1Task, NULL, NULL);
  led2Handle = osThreadNew(Led2Task, NULL, NULL);
  led3Handle = osThreadNew(Led3Task, NULL, NULL);
  led4Handle = osThreadNew(Led4Task, NULL, NULL);
